...
--- @param uiId string @界面ID
--- @param elementId string @元件ID
--- @param url string @图案纹理链接
function CustomUI:SetUrlIcon(playerId, uiId, elementId, url) return true end
...
--- @param uiId string @界面ID
--- @param elementId string @元件ID
--- @param actorId number @绑定的角色ID
--- @param offset table @相对偏移(含x,y,z字段)
function CustomUI:SetPositionBindActor(playerId, uiId, elementId, actorId, offset) return true end
...
--- @param uiId string @界面ID
--- @param elementId string @元件ID
function CustomUI:RemovePositionBindActor(playerId, uiId, elementId) return true end
...
--- @param uiId string @界面ID
--- @param elementId string @元件ID
--- @param blockPos table @方块坐标(含x,y,z字段)
function CustomUI:SetPositionBandBlock(playerId, uiId, elementId, blockPos) return true end
...
--- @param uiId string @界面ID
--- @param elementId string @元件ID
function CustomUI:RemovePositionBandBlock(playerId, uiId, elementId) return true end

--- 设置系统设置按钮是否显示
--- @return boolean @成功返回True, 失败返回False
--- @param playerId number @玩家ID
--- @param visible boolean @是否显示
function CustomUI:SetSysSettingBtnVisible(playerId, visible) return true end

--- 获取元件属性值
--- @return any @成功时返回元件属性值，失败返回nil
--- @param playerId number @玩家ID
--- @param elementId string @元件ID
--- @param attrIdx number @属性枚举(ElementAttr)
function CustomUI:GetElementAttrValue(playerId, elementId, attrIdx) return nil end

--- 获取界面属性值
--- @return any @成功时返回界面属性值，失败返回nil
--- @param playerId number @玩家ID
--- @param uiId string @界面ID
--- @param attrIdx number @属性枚举(ElementAttr)
function CustomUI:GetUIViewAttrValue(playerId, uiId, attrIdx) return nil end
...
--- @param playerId number @玩家ID
--- @param elementId string @元件ID
--- @param mapType number @信标地图类型枚举(BeaconMapType)
function CustomUI:SetBeaconMapType(playerId, elementId, mapType) return true end
